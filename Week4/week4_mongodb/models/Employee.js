...
.set(function(value){
  console.log(`trying to update the full name to ${value}`
  );
  //this.firstname = fullname
})


//Custom Schema Methods       ---------------------- SSSSS-------------
//1. Instance Method Declaration
EmployeeSchema.methods.getfullname = function(){
  return `${this.firstname} ${this.lastname}`
}

EmployeeSchema.method.getformattedslary = function(){
  return `$${this.salary}`
}


//2. Static method declararion
EmployeeSchema.static('getEmployeeFirstname', function(fname){
